...
python src/main.py --config ./config/ur_fall/ablation/acce_rgb/A30_B30_AB0_label_A_test_B
python src/main.py --config ./config/ur_fall/ablation/acce_rgb/A30_B30_AB0_label_B_test_A